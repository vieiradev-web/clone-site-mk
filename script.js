      ...
      if (temCobertura) {
        setFeedback(
          ...
          `
            ...
            <a href="https://wa.me/5581988776032?text=Olá! Consultei meu CEP (${cepInput.value}) no site e vi que há disponibilidade de cobertura. Quero contratar!"
               target="_blank"
        ...
        setFeedback('error', 'Infelizmente ainda não cobrimos este CEP. Fale com nosso suporte no WhatsApp para registrar interesse.');
      }
    } catch (error) {
